...
// Problem 1: Alphabetize email addresses
console.log(runners.map(e => e.email).sort());
// Problem 2: Find last names that start with "O"
console.log(runners.filter(e => e.last_name.charAt(0) == "O"));
// Problem 3: Find the highest donation
console.log(runners.reduce((most, runner) => {
  if (most < runner.donation) {
